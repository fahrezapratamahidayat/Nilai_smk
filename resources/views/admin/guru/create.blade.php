                ...
                <form action="{{ route('admin.guru.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('status_guru') is-invalid @enderror"
                            ...
                            <option value="wali_kelas" {{ old('status_guru') == 'wali_kelas' ? 'selected' : '' }}>Wali Kelas</option>
                            <option value="guru_mapel" {{ old('status_guru') == 'guru_mapel' ? 'selected' : '' }}>Guru Mata Pelajaran</option>
                        </select>
                        @error('status_guru')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
